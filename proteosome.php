...
<?php
    ...
    $query_string = "SELECT idEpitope, seqEpitope, Immunogenecity_score FROM Epitope WHERE ";
    foreach($output as $o){
...
?>
  ...
  <body>
    ...
    <div class="container">
      <a class="btn btn-primary btn-lg" href="queries.php" role="button">Go back</a>
      <div class="row">
        <h2>Epitopes</h2></h2>
      ...
      <tbody>
        <?php foreach($results as $row) { ?>
          <tr>
            <?php $idEpitope= $row['idEpitope']; ?>
            <td class="text-center"><?php echo "<a href='epitope.php?idEpitope={$idEpitope}' target='_blank'>$idEpitope</a>" ?>
